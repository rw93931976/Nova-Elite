...
try {
    ...
    console.log("🚀 Launching Core v7 (Brain) on Port 3508...");
    execSync('npx pm2 start core_v7.cjs --name core');

    // 3. Start Relay v5 on 3512 (bridging to 3508)
    console.log("📡 Launching Relay v5 (Gateway) on Port 3512...");
    ...
    console.log(" - Brain: 3508");
    console.log(" - Gateway: 3512");
    console.log(" - Nginx: Proxying /relay -> 3512");
} catch (error) {
