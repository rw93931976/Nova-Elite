...
export const SecondReviewSignal: React.FC<SecondReviewSignalProps> = ({
  ...
  return (
    <aside className="second-review" role="complementary" aria-label="Nova second review">
      ...
      <div className="second-review__head">
        ...
        <div>
          <span className="second-review__eyebrow">Second review · Nova</span>
      ...
      <p className="second-review__approver">
        <Shield size={14} />
        You remain the <strong>final approver</strong> — Nova advises; you decide.
      </p>
      <div className="second-review__actions">
        ...
        >
          {review.acknowledged ? 'Nova review noted' : "I've read Nova's review"}
        </button>
        <button
          type="button"
