...
const Autonomy: React.FC = () => {
  const [features, setFeatures] = useState<AutonomyFeature[]>([
    ...
    { id: "a6_1", name: "Sovereign Schooling", description: "Subject Filing Active", level: 6, completed: true, icon: <Rocket size={20} />, progress: 100 },
    { id: "a6_2", name: "Notebook Archival", description: "Autonomous Sync Active", level: 6, completed: true, icon: <Brain size={20} />, progress: 100 },
